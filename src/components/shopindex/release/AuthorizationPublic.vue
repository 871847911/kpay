  ...
  <div class="authorization">
    <div class="auth-info">
      ...
      <div>
        ...
        <button class="light unbind" @click="unbindVisible = true">解绑公众号</button>
      </div>
      <div>
        <p>公众号名称</p>
      ...
      <div>
        <p>店铺H5地址</p>
        <span>{{authData.h5Url}}</span>
        <p class="light" v-clipboard:copy="authData.h5Url" v-clipboard:success="onCopy" v-clipboard:error="onError">复制</p>
      </div>
      <div>
        <p>已授权权限</p>
    ...
    <el-dialog
      ...
      <div class="auth-again">
        <p>1、重新授权时不可换绑其他微信公众号 ，否则重新授权将失败；</p>
    ...
    <el-dialog
      ...
      <div class="unset-bind">
        ...
        <p>绑定开放平台，多个应用之间可以共享用户，不建议进行解绑操作。解绑后所有用户均无法登录公众号或小程序，请您谨慎操作。</p>
        <div class="bind-form">
...
export default {
  ...
  methods: {
    ...
    handleConfirmAuth(){
      ...
      window.open(`/backend/wechat/componentloginpagenew?storeId=${this.storeId}&authorizeType=1`, '_target')
    },
