                ...
                <div class="list-category-my list-course-common">
                    <el-table
                        ...
                        <el-table-column
                            ...
                            min-width="100">
                            <template slot-scope="scope">
                                <i class="iconfont icon-zitikuicon-" v-if="scope.row.status == 40" style="color:#6CDDC7;"></i>
                                <i class="iconfont icon-zitikuicon-" v-if="scope.row.status == 50" style="color:#F42C21;"></i>
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                ...
                                <el-button size="mini" v-if="scope.row.status == 40" @click="updateCourseStatus(scope.row.id, 50)">下架</el-button>
                                <el-button size="mini" v-if="scope.row.status == 50"  @click="updateCourseStatus(scope.row.id, 40)">上架</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
    ...
    getBaseInfo () {
      ...
      api.getBaseInfo().then(res => {
        if (res.success) {
          ...
          // if (that.roleId === 1) {
          //   that.newOptions = that.optionsOne
          // } else {
          //   that.newOptions = that.optionsTwo
          // }
          that.getMyCourse()
        }
      })
